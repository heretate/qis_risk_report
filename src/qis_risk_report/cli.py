...
@click.option("--date", "run_date", default=None, help="Report date (YYYY-MM-DD). Defaults to today.")
@click.option("--output-dir", default=None, help="Output directory. Defaults to reports/ from config.")
